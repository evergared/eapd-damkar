<div>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse show active" id="butuh-input-apdku">
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs mb-2" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="#tab-data-verif" data-toggle='pill' role="tab" aria-controls="tab-data-verif" wire:ignore.self>
                                Data Terverifikasi
                            </a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="collapse" id="kendali-input">
