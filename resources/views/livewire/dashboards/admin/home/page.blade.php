...
<section class="content">
    ...
    <div class="row">
      ...
      <div class="col-md-6 diklat">
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Diklat Ciracas</h3>
      ...
      <div class="col-md-6 laboraturium">
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Laboraturium</h3>
      ...
      <div class="col-md-6 sudin-pusat">
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Sudin Jakarta Pusat</h3>
                  ...
                  <div class="card-body table-responsive p-0" style="height: 300px;">
                    <table class="table table-head-fixed text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>44</td>
                          <td>Pengendalian Kebakaran dan Penyelamatan</td>
                          <td class="project_progress">
                            <a href="#"><div class="progress progress-sm">
                                <div class="progress-bar bg-green" role="progressbar" aria-valuenow="57" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
                                </div>
      ...
      <div class="col-md-6 sudin-utara">
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Sudin Jakarta Utara</h3>
      ...
      <div class="col-md-6 sudin-barat">
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Sudin Jakarta Barat</h3>
      ...
      <div class="col-md-6 sudin-selatan">
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Sudin Jakarta Selatan</h3>
      ...
      <div class="col-md-6 sudin-timur">
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Sudin Jakarta Timur</h3>
