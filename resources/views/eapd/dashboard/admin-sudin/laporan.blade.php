@extends('eapd.layouts.adminlte-dashboard',['title'=>'Laporan APD Admin Sudin'])

@section('content')


@include('eapd.dashboard.komponen.breadcrumbs',[ 'halamanJudul'=>'Laporan APD','halaman'=>'laporan'])
