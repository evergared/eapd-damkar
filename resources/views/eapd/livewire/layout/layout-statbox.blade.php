    ...
    <div class="row">
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
                ...
                <a href="#modal-jumlah" data-toggle="modal" data-target="#modal-jumlah"
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
                ...
                <a href="#modal-rusak" data-toggle="modal" data-target="#modal-rusak" class="small-box-footer">Informasi
                    <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
                ...
                <a href="#modal-capaian" data-toggle="modal" data-target="#modal-capaian"
                    class="small-box-footer">Informasi
                    <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
                ...
                <a href="#modal-validasi" data-toggle="modal" data-target="#modal-validasi"
